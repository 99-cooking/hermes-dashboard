...
export function seedChatMessages(db: Database.Database) {
  ...
  const messages = [
    ...
    },
    {
      ...
      from_agent: 'hermes',
      to_agent: 'apollo',
      content: 'Good. I\'ll engage with her X thread first — drop a value-add reply about outbound automation benchmarks. That way when your email lands, she\'ll recognize the Builderz name.',
      message_type: 'text',
